"use strict";
var e = [], t = [], o = "undefined" != typeof Uint8Array ? Uint8Array : Array, n = !1;

function a() {
    n = !0;
    for (var r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", o = 0, a = r.length; o < a; ++o) e[o] = r[o], t[r.charCodeAt(o)] = o;
    t["-".charCodeAt(0)] = 62, t["_".charCodeAt(0)] = 63
}

function h(r, t, o) {
    for (var n, a, h = [], c = t; c < o; c += 3) n = (r[c] << 16) + (r[c + 1] << 8) + r[c + 2], h.push(e[(a = n) >> 18 & 63] + e[a >> 12 & 63] + e[a >> 6 & 63] + e[63 & a]);
    return h.join("")
}
...
function fromByteArray(r) {
    var t;
    n || a();
    for (var o = r.length, c = o % 3, d = "", i = [], u = 16383, A = 0, f = o - c; A < f; A += u) i.push(h(r, A, A + u > f ? f : A + u));
    return 1 === c ? (t = r[o - 1], d += e[t >> 2], d += e[t << 4 & 63], d += "==") : 2 === c && (t = (r[o - 2] << 8) + r[o - 1], d += e[t >> 10], d += e[t >> 4 & 63], d += e[t << 2 & 63], d += "="), i.push(d), i.join("")
};
...
function toByteArray(r) {
    ...
    i = "=" === r[A - 2] ? 2 : "=" === r[A - 1] ? 1 : 0, u = new o(3 * A / 4 - i), c = i > 0 ? A - 4 : A;
    var f = 0;
    for (e = 0, h = 0; e < c; e += 4, h += 3) d = t[r.charCodeAt(e)] << 18 | t[r.charCodeAt(e + 1)] << 12 | t[r.charCodeAt(e + 2)] << 6 | t[r.charCodeAt(e + 3)], u[f++] = d >> 16 & 255, u[f++] = d >> 8 & 255, u[f++] = 255 & d;
    return 2 === i ? (d = t[r.charCodeAt(e)] << 2 | t[r.charCodeAt(e + 1)] >> 4, u[f++] = 255 & d) : 1 === i && (d = t[r.charCodeAt(e)] << 10 | t[r.charCodeAt(e + 1)] << 4 | t[r.charCodeAt(e + 2)] >> 2, u[f++] = d >> 8 & 255, u[f++] = 255 & d), u
}
...
const Sbox = Uint8Array.from([])
const CK = Uint32Array.from([0x00070e15, 0x1c232a31, 0x383f464d, 0x545b6269, 0x70777e85, 0x8c939aa1, 0xa8afb6bd, 0xc4cbd2d9, 0xe0e7eef5, 0xfc030a11, 0x181f262d, 0x343b4249, 0x50575e65, 0x6c737a81, 0x888f969d, 0xa4abb2b9, 0xc0c7ced5, 0xdce3eaf1, 0xf8ff060d, 0x141b2229, 0x30373e45, 0x4c535a61, 0x686f767d, 0x848b9299, 0xa0a7aeb5, 0xbcc3cad1, 0xd8dfe6ed, 0xf4fb0209, 0x10171e25, 0x2c333a41, 0x484f565d, 0x646b7279])
